...
@section('title', 'Admin - Venue Bookings')
      ...
      @include('partials.message-bag')
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span>Venue Bookings ({{ $bookings->count() }})</span>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $booking->venue->name ?? 'N/A' }} <br>
                                <span class="badge bg-info text-white">{{ $booking->package->name ?? 'N/A' }}</span><br>
                                Date: <strong>{{ \Carbon\Carbon::parse($booking->booking_date)->format('M d, Y') }}</strong>
                            </td>
                            <td>
