...
@section('title', 'Admin - Settings - Restaurant Tables')
      ...
      @include('partials.message-bag')
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <span>Restaurant Tables ({{ $tables->count() }})</span>
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><i class="typcn typcn-th-large mr-0"></i> {{ $table->name }}</td>
                            <td>
                                <button 
                        ...
                        @empty
                        <tr>
                            <td colspan="2" class="text-center">No Restaurant Tables available.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
            ...
            <form method="POST" action="{{ route('admin.restaurant-tables.store') }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createModalLabel">Add New Table</h5>
        ...
        <div class="modal-dialog">
            <form method="POST" id="editForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="editName">Table Name</label>
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      <form method="POST" id="deleteForm">
          ...
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="deleteModalLabel">Delete Table</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> <i class="fas fa-times"></i></button>
              </div>
              <div class="modal-body">
                  <p>Are you sure you want to delete <strong id="deletetableName"></strong>?</p>
                  <p class="text-warning">Warning: Deleting this Table will also delete all related menus and orders. This action cannot be undone.</p>
              </div>
              <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
